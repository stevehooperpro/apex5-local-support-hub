      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-2xl">
          ...
          <div className="prose prose-slate max-w-none text-muted-foreground space-y-6 text-sm leading-relaxed">
            ...
            <p>Apex5 is a local IT support business based in Colchester, Essex. Our website address is https://apex5.co.uk. For any privacy-related queries, contact us at apex5colchester@gmail.com.</p>
            ...
            <p>You have the right to request access to, correction of, or deletion of your personal data at any time. Contact us at apex5colchester@gmail.com to make a request.</p>
